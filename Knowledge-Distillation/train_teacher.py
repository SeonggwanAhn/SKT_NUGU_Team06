...
def get_model(args):
    if args.model.lower()=='lenet5':
     ...
     #   student = network.Tlenet.MergeModels(nF, nB, nC)

      #  return student
        return network.Nlenet.LeNet5()
...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if acc>best_acc:
            best_acc = acc
            torch.save(model.state_dict(),"checkpoint/teacher/%s-%s-w.pt"%(args.dataset, args.model))
